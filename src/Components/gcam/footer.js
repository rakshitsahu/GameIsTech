...
export default function Footer() {
  return (
    <footer className='w-full grid grid-cols-2 bg-gray-700 justify-items-center text-white gap-4 p-5'>
    <div className='DESCRIPTION flex flex-wrap font-light text-lg'>
    Thanks for visiting Game is tech. In this Application we aim to provide the best <Link href ='/apps/gcam'><font className = 'underline underline-offset-2 decoration-emerald-500'>Google Camera port</font></Link> for your device.  
We have made powerful filters to find the most compatible Gcam for your device and we are working on it to make it more better.
    ...
    © GameIsTech | All rights reserved
    </div>
